...
import { MobileSmartFilter } from './MobileSmartFilter';
...
}> = ({ selectedCities, onCitiesChange, searchQuery, onSearchChange }) => {
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">{category.mlFeatures.avgFootTraffic.toLocaleString()} tráfico promedio</div>
              </div>
            </div>
            {isSelected && <Check className="w-4 h-4 text-[#353FEF]" />}
          </button>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Sliders className="w-4 h-4 text-[#353FEF]" />

...
export const ModernFilterSystem = React.memo<ModernFilterSystemProps>(({
  ...
  return (
    <>
      {/* Compact Horizontal Filter System */}
      <div className={`hidden lg:block bg-white rounded-xl shadow-sm border border-gray-200 ${className}`}>
        <div className="p-4">
          <div className="flex items-center justify-between gap-4">
                ...
                {quickFilters.map(filter => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-sm font-medium transition-all ${
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <span className="text-sm text-gray-600">
                {resultCount} {resultCount === 1 ? 'pantalla' : 'pantallas'}
              </span>
          ...
          {/* Active Filter Chips */}
          {activeChips.length > 0 && (
            <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100 overflow-x-auto scrollbar-hide">

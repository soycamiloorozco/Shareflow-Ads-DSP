...
interface ModernScreenLocationMapProps {
  screen: Screen;
}
...
const ModernScreenLocationMap: React.FC<ModernScreenLocationMapProps> = ({ screen }) => {
...
export default ModernScreenLocationMap; 